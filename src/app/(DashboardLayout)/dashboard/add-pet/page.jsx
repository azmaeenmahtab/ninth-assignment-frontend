      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-md p-8">
        ...
        <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-4 col-span-2">
                ...
                <div className="flex gap-2">
                  ...
                  <label>
                    <input type="radio" name="gender" value="Female" className="accent-[#651028] ml-4" />
          ...
          <div className="flex justify-end gap-4 mt-6">
            <button type="button" className="rounded-full border border-gray-300 px-6 py-2 text-[#651028] font-semibold bg-white hover:bg-gray-100">Save Draft</button>
            <button type="submit" className="rounded-full bg-[#651028] px-6 py-2 text-white font-semibold hover:bg-[#4b0f1d]">Submit Listing</button>
          </div>
        </form>
      </div>
    </div>
