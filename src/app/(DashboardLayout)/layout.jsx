  ...
  return (
    ...
    <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6 md:py-4">
        ...
        <div className="flex items-center gap-3 md:gap-6">
            ...
            >
                <FontAwesomeIcon icon={faArrowLeft} className="text-(--text) text-sm" />
        ...
        <div className="relative">
            <button
                ...
                className="flex items-center gap-2 rounded-full bg-white/5 px-2 py-1 md:px-3 md:py-2"
                aria-haspopup="menu"
            ...
            >
                {isValidImageUrl ? (
                    ...
                    <span className="flex h-8 w-8 md:h-9 md:w-9 items-center justify-center rounded-full bg-gray-100 text-sm font-semibold">
                        {userInitial}
                    </span>
                )}
